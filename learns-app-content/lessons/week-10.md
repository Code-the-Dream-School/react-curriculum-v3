...
![highlighting class name change by CSS Modules](./assets/week-10/css-module-class-name.png)
...
![demonstrating style spilling over into h2's](./assets/week-10/green-headings.png)
...
![html screen capture showing component names in classes](./assets/week-10/styled-component-readable-class.png)
...
![showing class that applies styles in browser elements tab](./assets/week-10/styled-component-style-name.png)
...
![images highlighted on screen capture of CTD-Swag page](./assets/week-10/images-highlighted.png)
...
![screen capture showing image url for blue canvas bag](./assets/week-10/canvas-bag-blue.png)
![screen capture of IDE showing canvas-blag-blue image in project directory](./assets/week-10/canvas-blag-blue-hilight.png)
...
![screen capture in ide highlighting placeholder image import](./assets/week-10/placeholder-import.png)
![screen capture of page html highlighting placeholder image URL](./assets/week-10/placeholder-src.png)
